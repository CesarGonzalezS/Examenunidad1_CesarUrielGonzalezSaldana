<template>
  <b-container>
    <h1>Hola desde Formulario -  Repube 2</h1>
      ...
      <div>
          <b-form @submit="checkForm" novalidate>
              ...
              <b-form-group id="brand-group" label="Marca" label-for="brand" :state="validateField('brand')">
                  <b-form-input id="brand" v-model="formData.brand" type="text" name="brand" required></b-form-input>
              </b-form-group>

              <b-form-group id="model-group" label="Modelo" label-for="model" :state="validateField('model')">
                <b-form-input id="model" v-model="formData.model" type="text" name="model" required></b-form-input>
            </b-form-group>

              <b-form-group id="year-group" label="Año del coche " label-for="year" :state="validateField('year')">
              ...
              <b-button type="submit" variant="primary" >Registrar Coche</b-button>
              <b-button @click="navegarSiguiente">Ir a Paginación</b-button>
  ...
  methods: {
      ...
      checkForm: function (e) {
          ...
          if (!this.formData.model) {
              this.errors.push("La marca es obligatoria.");
          } else if (!/^[a-zA-Z0-9\s]+$/.test(this.formData.model)) {
              this.errors.push("La model debe ser alfanumérica y no debe contener signos.");
          }
          ...
          if (!this.formData.serie) {
              ...
              if (!regex.test(this.formData.serie)) {
                  this.errors.push("Ingrese un número de serie válido en el formato requerido.");
              }
          }
